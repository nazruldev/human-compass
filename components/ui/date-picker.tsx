...
interface BaseDatePickerProps {
  ...
  /** Override sheet background. Use preset "black"/"white" or custom "rgba(...)" */
  sheetBackgroundColor?: "black" | "white" | string;
}
...
export function DatePicker(props: DatePickerProps) {
  ...
  // When sheet has black/dark background, use white text and primary accents
  const isDarkSheet =
    sheetBackgroundColor === "black" ||
    (typeof sheetBackgroundColor === "string" &&
      sheetBackgroundColor.startsWith("rgba(0,0,0"));
  const sheetTextColor = isDarkSheet ? "#ffffff" : textColor;
  const sheetMutedColor = isDarkSheet
    ? "rgba(255,255,255,0.6)"
    : mutedForegroundColor;
  const sheetMutedBg = isDarkSheet ? "rgba(255,255,255,0.15)" : mutedColor;
    ...
    >
      <TouchableOpacity
        ...
        style={{
          ...
          backgroundColor: sheetMutedBg,
        }}
      >
        <ChevronLeft size={20} color={sheetTextColor} />
      </TouchableOpacity>
      ...
      >
        ...
        >
          ...
          <ChevronDown size={16} color={sheetTextColor} />
        </TouchableOpacity>
      ...
      >
        <ChevronRight size={20} color={sheetTextColor} />
      </TouchableOpacity>
    </View>
  );
    ...
    <View>
      ...
      >
        {DAYS.map((day) => (
          ...
          >
            <Text
              variant="caption"
              style={{ fontSize: 11, fontWeight: "600", color: sheetTextColor }}
            >
              {day}
            </Text>
          </View>
      ...
      {mode === "range" && (
        ...
        >
          ...
          >
            <ArrowRight color={sheetTextColor} strokeWidth={3} />
          </View>
  ...
  return (
    <>
      ...
      <BottomSheet
        ...
        transparentBackground={!sheetBackgroundColor}
        sheetBackgroundColor={
          sheetBackgroundColor === "black"
            ? "rgba(0,0,0,0.92)"
        ...
        sheetTitleColor={isDarkSheet ? "#ffffff" : undefined}
        sheetHandleColor={isDarkSheet ? "rgba(255,255,255,0.5)" : undefined}
      >
        <View style={{ flex: 1 }}>
            ...
            >
              {showTodayButton ? (
                <Button
                  ...
                  textStyle={
                    isDarkSheet ? { color: sheetTextColor } : undefined
                  }
                >
                  Today
                </Button>
              ...
              <Button
                ...
                textStyle={isDarkSheet ? { color: sheetTextColor } : undefined}
              >
